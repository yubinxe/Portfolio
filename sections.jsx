...
const TRAJECTORY = [
  ...
  { year: "2026", color: "var(--lilac)", title: "서울광역청년센터 나눔서포터즈 · CJ제일제당 나눔냉장고 운영",
    desc: "CJ제일제당과 서울광역청년센터가 연계한 나눔냉장고 프로그램에서 월간 식품 나눔·제로웨이스트 캠페인을 현장 운영하며, 청년의 가치소비 실천과 자기주도적 식습관 형성을 지원하는 사회공헌 프로세스를 수행." },
